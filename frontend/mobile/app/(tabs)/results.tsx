...
export default function ResultsScreen() {
  return (
    <SafeAreaView style={s.container}>
      <View style={s.header}><Text style={s.title}>Results</Text><Text style={s.sub}>Your academic performance</Text></View>
      <View style={s.placeholder}><Text style={s.emoji}>📊</Text><Text style={s.placeholderText}>Results view coming soon</Text></View>
    </SafeAreaView>
  );
}
